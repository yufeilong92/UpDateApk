...
public class ImageUtil 
{
	...
	public static String saveBitmap(Bitmap bitmap, boolean brecycle)
	{
		...
		String tempfilename = TimeUtil.dateToString(null, "yyyyMMddHHmmss")
				+ ".jpg";
		String filepath = Constants.getDataStoreDir() + Constants.CSTR_IMAGECACHEDIR;
	 ...
	 */
	public static String getDefaultImageFileFullPath(String imageUrl)
	{
		...
		return Constants.getDataStoreDir().concat(
	 ...
	 * @return
	 */
	public static boolean hasLocalFile(String imageurl)
	{
		File file = new File(
				ImageUtil.getDefaultImageFileFullPath(imageurl));
		return file.exists();
	}
}

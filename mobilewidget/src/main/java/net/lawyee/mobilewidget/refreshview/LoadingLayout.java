package net.lawyee.mobilewidget.refreshview;

import net.lawyee.mobilewidget.R;
...
public class LoadingLayout extends FrameLayout
{
			...
			String pullLabel, String refreshingLabel)
	{
		...
		headerText.setTextColor(context.getResources().getColor(
				R.color.pull_to_refresh_text_color));
